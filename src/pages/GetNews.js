...
function GetNews({ articles, activeArticle }) {
  ...
  useEffect(() => {
    ...
    if (articles.length) {
      console.log("get news redirect fired");
      const selectedArticle =
        articles && articles[Math.floor(Math.random() * articles.length - 1)];
      console.log("articles in use effect: ", articles);
      setBanner(articles[selectedArticle]);
    }
  }, [articles]);
